...
import (
	...
	"github.com/huannguyen2114/golang-project/snippetbox/internal/validator"
	"github.com/julienschmidt/httprouter"
)

// Update snippetCreateForm struct to include struct tags which tell the decoder how to map HTML form values in to the different struct fields.
...
func (app *application) snippetCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.PermittedInt(form.Expires, 1, 7, 365), "expires", "This field must euqal 1, 7 or 365")
